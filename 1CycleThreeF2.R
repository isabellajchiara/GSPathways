...
F1gv3 <- as.vector(mean(gv(F1)))
F2gv3 <- as.vector(mean(gv(F2)))
F3gv3 <- as.vector(mean(gv(F3)))
F4gv3 <- as.vector(mean(gv(F4)))
F5gv3 <- as.vector(mean(gv(F5)))
PYTgv3 <- as.vector(mean(gv(PYT)))
AYTgv3 <- as.vector(mean(gv(AYT)))
Varietygv3 <- as.vector(mean(gv(Variety)))

cycle3gv <- matrix(nrow=8, ncol=1)
cycle3gv[1,] <- F1gv3
cycle3gv[2,] <- F2gv3
cycle3gv[3,] <- F3gv3
cycle3gv[4,] <- F4gv3
...
cycle3gv[6,] <- PYTgv3
cycle3gv[7,] <- AYTgv3
cycle3gv[8,] <- Varietygv3

cycle3gvs <- as.matrix(cycle3gv)
