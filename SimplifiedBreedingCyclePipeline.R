...
for (cycle in 1:args$nCycles){
  ...
  updateResults(3, F1, "F1")
                              
  ## self and bulk F1 to form F2 ##

  F2 = self(F1, nProgeny = 30) 
  updateResults(4, F2, "F2")
